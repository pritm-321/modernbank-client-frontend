...
const submitHandler=(e)=>{
    ...
    if(password!==password2){
        ...
        try{
          dispatch(register(password,firstName,lastName,phone,email,aadhar,street,city,state,pincode))
          Swal.fire({
            title: 'Success!',
    ...
    <>
      <div className="register-wrapper">
        ...
        <div className="register-form">
          ...
          <div className="register-inputfield">
            <label className="register-retypepassword">Confirm Password</label>
            <input
              type="password"
